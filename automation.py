...
print("")
timeToStudy = int(input("Hello! When would you like to end your study session?(Enter in terms of mins): "))
#how often do we need to check the user?
severityLevel = input("How often should we check on you? (Severe, Moderate, Chill, Demo): ")
